...
export async function signUp(
  ...
  const validatedBody = validateRequest<SignUpInput>(
    signUpSchema,
    req.body,
    res
  );
...
export async function signIn(
  ...
  const validatedBody = validateRequest<SignInInput>(
    signInSchema,
    req.body,
    res
  );
...
export async function refreshToken(
  ...
  const validatedBody = validateRequest<RefreshTokenInput>(
    refreshTokenSchema,
    req.body,
    res
  );
...
export async function forgotPassword(
  ...
  const validatedBody = validateRequest<ForgotPasswordInput>(
    forgotPasswordSchema,
    req.body,
    res
  );
...
export async function resetPassword(
  ...
  const validatedBody = validateRequest<ResetPasswordInput>(
    resetPasswordSchema,
    req.body,
    res
  );
