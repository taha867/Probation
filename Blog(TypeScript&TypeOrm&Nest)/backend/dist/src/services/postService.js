...
export class PostService {
    ...
    async createPost(params) {
        ...
        // Use repository create method instead of manual entity construction
     ...
     */
    async getPostWithComments(params) {
        ...
        const [comments, total] = await this.commentRepo.findTopLevelWithReplies(postId, page, limit);
        return {
            post: basePost,
            comments: comments, // usage of any removed
     ...
     */
    async updatePostForUser(params) {
        ...
        if (fileBuffer) {
            ...
            const uploadResult = await uploadImageToCloudinary(fileBuffer, "blog/posts", fileName || "updated-image");
     ...
     */
    async deletePostForUser(params) {
