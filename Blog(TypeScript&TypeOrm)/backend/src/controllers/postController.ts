...
export async function create(req: Request, res: Response): Promise<void> {
  ...
  const validatedBody = validateRequest<CreatePostInput>(
    createPostSchema,
    req.body,
    res
  );
...
export async function list(req: Request, res: Response): Promise<void> {
  const validatedQuery = validateRequest<ListPostsQuery>(
    listPostsQuerySchema,
    req.query,
    res,
    { convert: true }
...
export async function update(req: Request, res: Response): Promise<void> {
  try {
    ...
    const validatedBody = validateRequest<UpdatePostInput>(
      updatePostSchema,
      req.body,
      res
    );
    ...
    const updateData: UpdatePostInput = Object.fromEntries(
