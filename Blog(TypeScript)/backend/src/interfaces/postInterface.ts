...
import type { CommentWithAuthor } from "./commentInterface.js";
...
export interface CreatePostInput {
  title: string;
  body: string;
  status?: PostStatus; // Optional, defaults to "draft"
  image?: string | null; // Set after Cloudinary upload
  imagePublicId?: string | null; // Set after Cloudinary upload
}
...
export interface UpdatePostInput {
  ...
  body?: string;
  status?: PostStatus;
  image?: string | null; // Can be set to null to remove image
}
...
/**
 * Post data from Sequelize model
 * Complete post data structure returned from post.get()
 * Used when destructuring post data from Sequelize models
 */
